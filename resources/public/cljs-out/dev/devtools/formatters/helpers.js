...
var G__11554 = devtools.prefs.pref.call(null,v);
v = G__11554;
continue;
} else {
return v;
...
}catch (e11557){var _e__10571__auto__ = e11557;
return false;
}})();
...
}catch (e11561){var _e__10571__auto__ = e11561;
return false;
}})();
...
}catch (e11563){var _e__10571__auto__ = e11563;
return false;
}}
}
});
...
var vec__11565 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11565,(0),null);
...
return cljs.core.some.call(null,(function (p1__11568_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11568_SHARP_);
}),template);
});
