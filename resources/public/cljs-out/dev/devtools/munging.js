...
var o11452 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11452["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11453 = temp__5455__auto____$1;
return (o11453["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10564__auto__ = f;
return (o__10564__auto__["toString"]).call(o__10564__auto__);
} else {
return "";
}
}catch (e11454){var _ = e11454;
return "";
}});
...
try{var o__10564__auto___11456 = t;
(o__10564__auto___11456["cljs$lang$ctorPrWriter"]).call(o__10564__auto___11456,t,writer);
}catch (e11455){var __11457 = e11455;
}
...
var char_code = (function (){var o__10564__auto__ = (new String(char$));
return (o__10564__auto__["charCodeAt"]).call(o__10564__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10564__auto__ = String;
return (o__10564__auto__["fromCharCode"]).call(o__10564__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11458 = num_code;
switch (G__11458) {
case (1):
return (185);
...
var o__10564__auto__ = String;
return (o__10564__auto__["fromCharCode"]).call(o__10564__auto__,superscript_code);
});
/**
...
}catch (e11460){var _e__10571__auto__ = e11460;
return false;
}})())){
...
var vec__11461 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11461,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11464 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11464["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11465 = temp__5455__auto____$1;
return (o11465["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___11472 = arguments.length;
var i__4532__auto___11473 = (0);
while(true){
if((i__4532__auto___11473 < len__4531__auto___11472)){
args__4534__auto__.push((arguments[i__4532__auto___11473]));

var G__11474 = (i__4532__auto___11473 + (1));
i__4532__auto___11473 = G__11474;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11468){
var vec__11469 = p__11468;
var ns_detector = cljs.core.nth.call(null,vec__11469,(0),null);
...
var G__11475 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11476 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11475;
remaining_tokens = G__11476;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11466){
var G__11467 = cljs.core.first.call(null,seq11466);
var seq11466__$1 = cljs.core.next.call(null,seq11466);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11467,seq11466__$1);
});
...
var vec__11480 = cljs.core.split_with.call(null,(function (p1__11479_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11479_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11480,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11480,(1),null);
...
var vec__11483 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11483,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11483,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11486 = cljs.core.rest.call(null,remaining_tokens);
var G__11487 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11486;
name_tokens = G__11487;
continue;
} else {
...
var vec__11490 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11490,(0),null);
var arity = cljs.core.nth.call(null,vec__11490,(1),null);
var vec__11493 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11493,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11493,(1),null);
var vec__11496 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11496,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11496,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11496,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11496,(3),null);
...
var munged_ns = cljs.core.nth.call(null,vec__11502,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11502,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11502,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11502,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11502,(4),null);
var arity = cljs.core.nth.call(null,vec__11502,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11506 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11506,(0),null);
var args = cljs.core.nth.call(null,vec__11506,(1),null);
var vec__11509 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11509,(0),null);
var name = cljs.core.nth.call(null,vec__11509,(1),null);
...
var G__11512 = (arity + (1));
var G__11513 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11514){
var vec__11515 = p__11514;
var arity = cljs.core.nth.call(null,vec__11515,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11515,(1),null);
...
return cljs.core.get.call(null,arities,p1__11518_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11519_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11522){
var vec__11523 = p__11522;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11523,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11520){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11531__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11531__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11531__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11531__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11532 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11532,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11532,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11532,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11532,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11532,(4),null);
var arity = cljs.core.nth.call(null,vec__11532,(5),null);
...
var o__10564__auto__ = f;
return (o__10564__auto__["getBasis"]).call(o__10564__auto__);
});
/**
...
}catch (e11536){var _e__10571__auto__ = e11536;
...
var G__11537 = (obj[cljs.core.first.call(null,path)]);
var G__11538 = cljs.core.rest.call(null,path);
obj = G__11537;
path = G__11538;
continue;
} else {
...
return (function (accum,p__11539){
var vec__11540 = p__11539;
var bit = cljs.core.nth.call(null,vec__11540,(0),null);
var protocol = cljs.core.nth.call(null,vec__11540,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11543){
...
var selector = cljs.core.nth.call(null,vec__11544,(2),null);
...
return (function (p__11548){
var vec__11549 = p__11548;
var munged_name = cljs.core.nth.call(null,vec__11549,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11549,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11549,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11547_SHARP_){
return (obj[cljs.core.first.call(null,p1__11547_SHARP_)]);
});})(name,sorted_matches,vec__11549,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
