...
var G__10033 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10033,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10033;
}
});
...
var len__4531__auto___10038 = arguments.length;
var i__4532__auto___10039 = (0);
while(true){
if((i__4532__auto___10039 < len__4531__auto___10038)){
args__4534__auto__.push((arguments[i__4532__auto___10039]));

var G__10040 = (i__4532__auto___10039 + (1));
i__4532__auto___10039 = G__10040;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10035){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10036,G__10037,seq10035__$2);
});
...
var file = cljs.core.get.call(null,map__10042__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10042__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10042__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10042,map__10042__$1,file,line,column){
return (function (p1__10041_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10041_SHARP_));
});})(map__10042,map__10042__$1,file,line,column))
...
var temp__5457__auto___10044 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10044)){
var message_10045 = temp__5457__auto___10044;
cljs.core.println.call(null,message_10045);
} else {
}
...
var temp__5457__auto___10046 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10046)){
var message_10047 = temp__5457__auto___10046;
cljs.core.println.call(null,message_10047);
} else {
}
...
var output_dir__$1 = (function (){var G__10048 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10048),"/"].join('');
} else {
return G__10048;
}
})();
...
var G__10050 = exception.stack;
var G__10050__$1 = (((G__10050 == null))?null:clojure.string.split_lines.call(null,G__10050));
var G__10050__$2 = (((G__10050__$1 == null))?null:cljs.core.get.call(null,G__10050__$1,depth));
if((G__10050__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10050__$2);
}
} else {
...
var vec__10051 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10051,(0),null);
var column = cljs.core.nth.call(null,vec__10051,(1),null);
var vec__10054 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10054,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10054,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10054,(2),null);
...
var m__$1 = (function (){var G__10057 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10061 = (function (){var G__10060 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10060);
} else {
return G__10060;
}
})();
...
return cljs.core.vary_meta.call(null,G__10062,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10066 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10066,(0),null);
var types = vec__10066;
...
return cljs.core.map.call(null,(function (p__10069){
var vec__10070 = p__10069;
var ns = cljs.core.nth.call(null,vec__10070,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10070,(1),null);
return ((function (vec__10070,ns,vars__$1){
return (function (){
...
var G__10073 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1){
return (function (){
var seq__10074 = cljs.core.seq.call(null,vars__$1);
var chunk__10075 = null;
var count__10076 = (0);
var i__10077 = (0);
while(true){
if((i__10077 < count__10076)){
var v = cljs.core._nth.call(null,chunk__10075,i__10077);
var temp__5457__auto___10079 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10079)){
var t_10080 = temp__5457__auto___10079;
each_fixture_fn.call(null,((function (seq__10074,chunk__10075,count__10076,i__10077,t_10080,temp__5457__auto___10079,v,each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10080)));
});})(seq__10074,chunk__10075,count__10076,i__10077,t_10080,temp__5457__auto___10079,v,each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1))
);
} else {
}


var G__10081 = seq__10074;
var G__10082 = chunk__10075;
var G__10083 = count__10076;
var G__10084 = (i__10077 + (1));
seq__10074 = G__10081;
chunk__10075 = G__10082;
count__10076 = G__10083;
i__10077 = G__10084;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10074);
if(temp__5457__auto__){
var seq__10074__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10074__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__10074__$1);
var G__10085 = cljs.core.chunk_rest.call(null,seq__10074__$1);
var G__10086 = c__4351__auto__;
var G__10087 = cljs.core.count.call(null,c__4351__auto__);
var G__10088 = (0);
seq__10074 = G__10085;
chunk__10075 = G__10086;
count__10076 = G__10087;
i__10077 = G__10088;
continue;
} else {
var v = cljs.core.first.call(null,seq__10074__$1);
var temp__5457__auto___10089__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10089__$1)){
var t_10090 = temp__5457__auto___10089__$1;
each_fixture_fn.call(null,((function (seq__10074,chunk__10075,count__10076,i__10077,t_10090,temp__5457__auto___10089__$1,v,seq__10074__$1,temp__5457__auto__,each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10090)));
});})(seq__10074,chunk__10075,count__10076,i__10077,t_10090,temp__5457__auto___10089__$1,v,seq__10074__$1,temp__5457__auto__,each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1))
);
} else {
}


var G__10091 = cljs.core.next.call(null,seq__10074__$1);
var G__10092 = null;
var G__10093 = (0);
var G__10094 = (0);
seq__10074 = G__10091;
chunk__10075 = G__10092;
count__10076 = G__10093;
i__10077 = G__10094;
continue;
}
} else {
...
});})(each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1))
);
});})(each_fixture_fn,G__10073,G__10073__$1,env,once_fixtures,each_fixtures,vec__10070,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10073__$1)].join('')));

}
})());
});
;})(vec__10070,ns,vars__$1))
