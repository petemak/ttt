...
var G__8569 = o;
(G__8569[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__8573 = o;
(G__8573[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__8574__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__8574 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8575__i = 0, G__8575__a = new Array(arguments.length -  0);
while (G__8575__i < G__8575__a.length) {G__8575__a[G__8575__i] = arguments[G__8575__i + 0]; ++G__8575__i;}
  args = new cljs.core.IndexedSeq(G__8575__a,0,null);
} 
return G__8574__delegate.call(this,args);};
G__8574.cljs$lang$maxFixedArity = 0;
G__8574.cljs$lang$applyTo = (function (arglist__8576){
var args = cljs.core.seq(arglist__8576);
return G__8574__delegate(args);
});
...
return cljs.core.assoc.call(null,G__8578__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__8579){
...
var props = map__8580__$1;
var class$ = cljs.core.get.call(null,map__8580__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__8580,map__8580__$1,props,class$){
return (function (c){
...
});})(map__8580,map__8580__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8582){
...
var on_write = cljs.core.get.call(null,map__8583__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__8583,map__8583__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__8583,map__8583__$1,on_write))
);
} else {
...
var vec__8589 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8589,(0),null);
var id = cljs.core.nth.call(null,vec__8589,(1),null);
var class$ = cljs.core.nth.call(null,vec__8589,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___8593 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___8593 == null)){
} else {
var key_8594 = temp__5461__auto___8593;
...
var temp__5461__auto___8595 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___8595 == null)){
} else {
var key_8596 = temp__5461__auto___8595;
reagent.impl.template.oset.call(null,jsprops,"key",key_8596);
}
...
var G__8597 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__8597["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8600){
...
break;
default:
var G__8607 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__8607;
continue;
...
var n__4408__auto___8609 = a.length;
var i_8610 = (0);
while(true){
if((i_8610 < n__4408__auto___8609)){
(a[i_8610] = reagent.impl.template.as_element.call(null,(a[i_8610])));

var G__8611 = (i_8610 + (1));
i_8610 = G__8611;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___8612 = a.length;
var i_8613 = (0);
while(true){
if((i_8613 < n__4408__auto___8612)){
var val_8614 = (a[i_8613]);
if(((cljs.core.vector_QMARK_.call(null,val_8614)) && ((reagent.impl.template.key_from_vec.call(null,val_8614) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_8613] = reagent.impl.template.as_element.call(null,val_8614));

var G__8615 = (i_8613 + (1));
i_8613 = G__8615;
continue;
} else {
}
...
var ctx = ({});
var vec__8616 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__8616,(0),null);
var derefed = cljs.core.nth.call(null,vec__8616,(1),null);
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__8619){
